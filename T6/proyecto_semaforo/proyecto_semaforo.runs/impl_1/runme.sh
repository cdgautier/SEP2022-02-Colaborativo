...
HD_PWD='C:/Users/Camilo/Desktop/SEP/in_vivado_projects/proyecto_semaforo/proyecto_semaforo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_semaforo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_semaforo.tcl -notrace
