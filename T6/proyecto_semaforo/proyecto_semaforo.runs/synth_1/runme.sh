...
HD_PWD='C:/Users/Camilo/Desktop/SEP/in_vivado_projects/proyecto_semaforo/proyecto_semaforo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_semaforo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_semaforo.tcl
